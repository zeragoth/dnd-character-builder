...
from source_books import PHB, SCAG, EE, VGtM, MToF, XGtE, TCoE, FToD, GotG, Eberron, Ravnica, Theros, Strixhaven, Wildemount, RR


artificer_cantrips, artificer_spells_1, artificer_spells_2, artificer_spells_3, artificer_spells_4, artificer_spells_5 = [], [], [], [], [], []
bard_cantrips, bard_spells_1, bard_spells_2, bard_spells_3, bard_spells_4, bard_spells_5, bard_spells_6, bard_spells_7, bard_spells_8, bard_spells_9 = [], [], [], [], [], [], [], [], [], []
cleric_cantrips, cleric_spells_1, cleric_spells_2, cleric_spells_3, cleric_spells_4, cleric_spells_5, cleric_spells_6, cleric_spells_7, cleric_spells_8, cleric_spells_9 = [], [], [], [], [], [], [], [], [], []
druid_cantrips, druid_spells_1, druid_spells_2, druid_spells_3, druid_spells_4, druid_spells_5, druid_spells_6, druid_spells_7, druid_spells_8, druid_spells_9 = [], [], [], [], [], [], [], [], [], []
paladin_spells_1, paladin_spells_2, paladin_spells_3, paladin_spells_4, paladin_spells_5,  = [], [], [], [], []
ranger_spells_1, ranger_spells_2, ranger_spells_3, ranger_spells_4, ranger_spells_5,  = [], [], [], [], []
sorcerer_cantrips, sorcerer_spells_1, sorcerer_spells_2, sorcerer_spells_3, sorcerer_spells_4, sorcerer_spells_5, sorcerer_spells_6, sorcerer_spells_7, sorcerer_spells_8, sorcerer_spells_9 = [], [], [], [], [], [], [], [], [], []
warlock_cantrips, warlock_spells_1, warlock_spells_2, warlock_spells_3, warlock_spells_4, warlock_spells_5, warlock_spells_6, warlock_spells_7, warlock_spells_8, warlock_spells_9 = [], [], [], [], [], [], [], [], [], []
wizard_cantrips, wizard_spells_1, wizard_spells_2, wizard_spells_3, wizard_spells_4, wizard_spells_5, wizard_spells_6, wizard_spells_7, wizard_spells_8, wizard_spells_9,  = [], [], [], [], [], [], [], [], [], []
...
def create_spell_list():
    books = PC.books
    if PHB in books:
        bard_cantrips.extend(phb_bard_cantrips)
        bard_spells_1.extend(phb_bard_spells_1)
        bard_spells_2.extend(phb_bard_spells_2)
        bard_spells_3.extend(phb_bard_spells_3)
        bard_spells_4.extend(phb_bard_spells_4)
        bard_spells_5.extend(phb_bard_spells_5)
        bard_spells_6.extend(phb_bard_spells_6)
        bard_spells_7.extend(phb_bard_spells_7)
        bard_spells_8.extend(phb_bard_spells_8)
        bard_spells_9.extend(phb_bard_spells_9)

        cleric_cantrips.extend(phb_cleric_cantrips)
        cleric_spells_1.extend(phb_cleric_spells_1)
        cleric_spells_2.extend(phb_cleric_spells_2)
        cleric_spells_3.extend(phb_cleric_spells_3)
        cleric_spells_4.extend(phb_cleric_spells_4)
        cleric_spells_5.extend(phb_cleric_spells_5)
        cleric_spells_6.extend(phb_cleric_spells_6)
        cleric_spells_7.extend(phb_cleric_spells_7)
        cleric_spells_8.extend(phb_cleric_spells_8)
        cleric_spells_9.extend(phb_cleric_spells_9)

        druid_cantrips.extend(phb_druid_cantrips)
        druid_spells_1.extend(phb_druid_spells_1)
        druid_spells_2.extend(phb_druid_spells_2)
        druid_spells_3.extend(phb_druid_spells_3)
        druid_spells_4.extend(phb_druid_spells_4)
        druid_spells_5.extend(phb_druid_spells_5)
        druid_spells_6.extend(phb_druid_spells_6)
        druid_spells_7.extend(phb_druid_spells_7)
        druid_spells_8.extend(phb_druid_spells_8)
        druid_spells_9.extend(phb_druid_spells_9)

        paladin_spells_1.extend(phb_paladin_spells_1)
        paladin_spells_2.extend(phb_paladin_spells_2)
        paladin_spells_3.extend(phb_paladin_spells_3)
        paladin_spells_4.extend(phb_paladin_spells_4)
        paladin_spells_5.extend(phb_paladin_spells_5)

        ranger_spells_1.extend(phb_ranger_spells_1)
        ranger_spells_2.extend(phb_ranger_spells_2)
        ranger_spells_3.extend(phb_ranger_spells_3)
        ranger_spells_4.extend(phb_ranger_spells_4)
        ranger_spells_5.extend(phb_ranger_spells_5)

        sorcerer_cantrips.extend(phb_sorcerer_cantrips)
        sorcerer_spells_1.extend(phb_sorcerer_spells_1)
        sorcerer_spells_2.extend(phb_sorcerer_spells_2)
        sorcerer_spells_3.extend(phb_sorcerer_spells_3)
        sorcerer_spells_4.extend(phb_sorcerer_spells_4)
        sorcerer_spells_5.extend(phb_sorcerer_spells_5)
        sorcerer_spells_6.extend(phb_sorcerer_spells_6)
        sorcerer_spells_7.extend(phb_sorcerer_spells_7)
        sorcerer_spells_8.extend(phb_sorcerer_spells_8)
        sorcerer_spells_9.extend(phb_sorcerer_spells_9)

        warlock_cantrips.extend(phb_warlock_cantrips)
        warlock_spells_1.extend(phb_warlock_spells_1)
        warlock_spells_2.extend(phb_warlock_spells_2)
        warlock_spells_3.extend(phb_warlock_spells_3)
        warlock_spells_4.extend(phb_warlock_spells_4)
        warlock_spells_5.extend(phb_warlock_spells_5)
        warlock_spells_6.extend(phb_warlock_spells_6)
        warlock_spells_7.extend(phb_warlock_spells_7)
        warlock_spells_8.extend(phb_warlock_spells_8)
        warlock_spells_9.extend(phb_warlock_spells_9)

        wizard_cantrips.extend(phb_wizard_cantrips)
        wizard_spells_1.extend(phb_wizard_spells_1)
        wizard_spells_2.extend(phb_wizard_spells_2)
        wizard_spells_3.extend(phb_wizard_spells_3)
        wizard_spells_4.extend(phb_wizard_spells_4)
        wizard_spells_5.extend(phb_wizard_spells_5)
        wizard_spells_6.extend(phb_wizard_spells_6)
        wizard_spells_7.extend(phb_wizard_spells_7)
        wizard_spells_8.extend(phb_wizard_spells_8)
        wizard_spells_9.extend(phb_wizard_spells_9)
    if SCAG in books:
        sorcerer_cantrips.extend(scag_sorcerer_cantrips)
        warlock_cantrips.extend(scag_warlock_cantrips)
        wizard_cantrips.extend(scag_wizard_cantrips)
    if EE in books:
        artificer_cantrips.extend(ee_artificer_cantrips)
        artificer_spells_1.extend(ee_artificer_spells_1)
        artificer_spells_2.extend(ee_artificer_spells_2)
        artificer_spells_3.extend(ee_artificer_spells_3)
        artificer_spells_4.extend(ee_artificer_spells_4)
        artificer_spells_5.extend(ee_artificer_spells_5)

        bard_cantrips.extend(ee_bard_cantrips)
        bard_spells_1.extend(ee_bard_spells_1)
        bard_spells_2.extend(ee_bard_spells_2)

        druid_cantrips.extend(ee_druid_cantrips)
        druid_spells_1.extend(ee_druid_spells_1)
        druid_spells_2.extend(ee_druid_spells_2)
        druid_spells_3.extend(ee_druid_spells_3)
        druid_spells_4.extend(ee_druid_spells_4)
        druid_spells_5.extend(ee_druid_spells_5)
        druid_spells_6.extend(ee_druid_spells_6)
        druid_spells_7.extend(ee_druid_spells_7)

        ranger_spells_1.extend(ee_ranger_spells_1)
        ranger_spells_3.extend(ee_ranger_spells_3)

        sorcerer_cantrips.extend(ee_sorcerer_cantrips)
        sorcerer_spells_1.extend(ee_sorcerer_spells_1)
        sorcerer_spells_2.extend(ee_sorcerer_spells_2)
        sorcerer_spells_3.extend(ee_sorcerer_spells_3)
        sorcerer_spells_4.extend(ee_sorcerer_spells_4)
        sorcerer_spells_5.extend(ee_sorcerer_spells_5)
        sorcerer_spells_6.extend(ee_sorcerer_spells_6)
        sorcerer_spells_8.extend(ee_sorcerer_spells_8)

        warlock_cantrips.extend(ee_warlock_cantrips)
        warlock_spells_2.extend(ee_warlock_spells_2)
        warlock_spells_4.extend(ee_warlock_spells_4)
        warlock_spells_6.extend(ee_warlock_spells_6)

        wizard_cantrips.extend(ee_wizard_cantrips)
        wizard_spells_1.extend(ee_wizard_spells_1)
        wizard_spells_2.extend(ee_wizard_spells_2)
        wizard_spells_3.extend(ee_wizard_spells_3)
        wizard_spells_4.extend(ee_wizard_spells_4)
        wizard_spells_5.extend(ee_wizard_spells_5)
        wizard_spells_6.extend(ee_wizard_spells_6)
        wizard_spells_7.extend(ee_wizard_spells_7)
        wizard_spells_8.extend(ee_wizard_spells_8)
    if XGtE in books:
        pass
    if TCoE in books:
        pass
...
phb_bard_cantrips = ["Blade Ward", "Dancing Lights", "Friends", "Light", "Mage Hand", "Mending", "Message",
                 "Minor Illusion", "Prestidigitation", "True Strike", "Vicious Mockery"]
phb_bard_spells_1 = ["Animal Friendship", "Bane", "Charm Person", "Comprehend Languages", "Cure Wounds", "Detect Magic",
...
phb_bard_spells_2 = ["Animal Messenger", "Blindness/Deafness", "Calm Emotions", "Cloud of Daggers", "Crown of Madness",
...
phb_bard_spells_3 = ["Bestow Curse", "Clairvoyance", "Dispel Magic", "Fear", "Feign Death", "Glyph of Warding",
...
phb_bard_spells_4 = ["Compulsion", "Confusion", "Dimension Door", "Freedom of Movement", "Greater Invisibility",
                 "Hallucinatory Terrain", "Locate Creature", "Polymorph"]
phb_bard_spells_5 = ["Animate Objects", "Awaken", "Dominate Person", "Dream", "Geas", "Greater Restoration",
...
phb_bard_spells_6 = ["Eyebite", "Find the Path", "Guards and Wards", "Mass Suggestion", "Otto's Irresistible Dance",
                 "Programmed Illusion", "True Seeing"]
phb_bard_spells_7 = ["Etherealness", "Forcecage", "Mirage Arcane", "Mordenkainen's Magnificent Mansion",
                 "Mordenkainen's Sword", "Project Image", "Regenerate", "Resurrection", "Symbol", "Teleport"]
phb_bard_spells_8 = ["Dominate Monster", "Feeblemind", "Glibness", "Mind Blank", "Power Word Stun"]
phb_bard_spells_9 = ["Foresight", "Power Word Heal", "Power Word Kill", "True Polymorph"]


phb_cleric_cantrips = ["Guidance", "Light", "Mending", "Resistance", "Sacred Flame", "Spare the Dying", "Thaumaturgy"]
phb_cleric_spells_1 = ["Bane", "Bless", "Command", "Create or Destroy Water", "Cure Wounds", "Detect Evil and Good",
...
phb_cleric_spells_2 = ["Aid", "Augury", "Blindness/Deafness", "Calm Emotions", "Continual Flame", "Enhance Ability",
                   ...
                   "Zone of Truth"]
phb_cleric_spells_3 = ["Animate Dead", "Beacon of Hope", "Bestow Curse", "Clairvoyance", "Create Food and Water",
...
phb_cleric_spells_4 = ["Banishment", "Control Water", "Death Ward", "Divination", "Freedom of Movement",
                   "Guardian of Faith", "Locate Creature", "Stone Shape"]
phb_cleric_spells_5 = ["Commune", "Contagion", "Dispel Evil and Good", "Flame Strike", "Geas", "Greater Restoration",
                   "Hallow", "Insect Plague", "Legend Lore", "Mass Cure Wounds", "Planar Binding", "Raise Dead",
                   "Scrying"]
phb_cleric_spells_6 = ["Blade Barrier", "Create Undead", "Find the Path", "Forbiddance", "Harm", "Heal",
                   "Heroes' Feast", "Planar Ally", "True Seeing", "Word of Recall"]
phb_cleric_spells_7 = ["Conjure Celestial", "Divine Word", "Etherealness", "Fire Storm", "Plane Shift", "Regenerate",
                   "Resurrection", "Symbol"]
phb_cleric_spells_8 = ["Antimagic Field", "Control Weather", "Earthquake", "Holy Aura"]
phb_cleric_spells_9 = ["Astral Projection", "Gate", "Mass Heal", "True Resurrection"]


phb_druid_cantrips = ["Druidcraft", "Guidance", "Mending", "Poison Spray", "Produce Flame", "Resistance",
                  "Shillelagh", "Thorn Whip"]
phb_druid_spells_1 = ["Animal Friendship", "Charm Person", "Create or Destroy Water", "Cure Wounds", "Detect Magic",
...
phb_druid_spells_2 = ["Animal Messenger", "Barkskin", "Beast Sense", "Darkvision", "Enhance Ability", "Find Traps",
...
phb_druid_spells_3 = ["Call Lightning", "Conjure Animals", "Daylight", "Dispel Magic", "Feign Death",
                  "Meld into Stone", "Plant Growth", "Protection from Energy", "Sleet Storm", "Speak with Plants",
                  "Water Breathing", "Water Walk", "Wind Wall"]
phb_druid_spells_4 = ["Blight", "Confusion", "Conjure Minor Elementals", "Conjure Woodland Beings", "Control Water",
...
phb_druid_spells_5 = ["Antilife Shell", "Awaken", "Commune with Nature", "Conjure Elemental", "Contagion", "Geas",
                  "Greater Restoration", "Insect Plague", "Mass Cure Wounds", "Planar Binding", "Reincarnate",
                  "Scrying", "Tree Stride", "Wall of Stone"]
phb_druid_spells_6 = ["Conjure Fey", "Find the Path", "Heal", "Heroes' Feast", "Move Earth", "Sunbeam",
                  "Transport via Plants", "Wall of Thorns", "Wind Walk"]
phb_druid_spells_7 = ["Fire Storm", "Mirage Arcane", "Plane Shift", "Regenerate", "Reverse Gravity"]
phb_druid_spells_8 = ["Animal Shapes", "Antipathy/Sympathy", "Control Weather", "Earthquake", "Feeblemind",
                  "Sunburst", "Tsunami"]
phb_druid_spells_9 = ["Foresight", "Shapechange", "Storm of Vengeance", "True Resurrection"]


phb_paladin_spells_1 = ["Bless", "Command", "Compelled Duel", "Cure Wounds", "Detect Evil and Good", "Detect Magic",
...
phb_paladin_spells_2 = ["Aid", "Branding Smite", "Find Steed", "Lesser Restoration", "Locae Object", "Magic Weapon",
                    "Protection from Poison", "Zone of Truth"]
phb_paladin_spells_3 = ["Aura of Vitality", "Blinding Smite", "Create Food and Water", "Crusader's Mantle",
                    "Daylight", "Dispel Magic", "Elemental Weapon", "Magic Circle", "Remove Curse", "Revivify"]
phb_paladin_spells_4 = ["Aura of Life", "Aura of Purity", "Banishment", "Death Ward", "Locate Creature", "Staggering Smite"]
phb_paladin_spells_5 = ["Banishing Smite", "Circle of Power", "Destructive Wave", "Dispel Evil and Good", "Geas",
                    "Raise Dead"]


phb_ranger_spells_1 = ["Alarm", "Animal Friendship", "Cure Wounds", "Detect Magic", "Detect Poison and Disease",
                   "Ensnaring Strike", "Fog Cloud", "Goodberry", "Hail of Thorns", "Hunter's Mark", "Jump",
                   "Longstrider", "Speak with Animals"]
phb_ranger_spells_2 = ["Animal Messenger", "Barkskin", "Beast Sense", "Cordon of Arrows", "Darkvision", "Find Traps",
                   "Lesser Restoration", "Locate Animals or Plants", "Locate Object", "Pass without Trace",
                   "Protection from Poison", "Silence", "Spike Growth"]
phb_ranger_spells_3 = ["Conjure Animals", "Conjure Barrage", "Daylight", "Lightning Arrow", "Nondetection",
                   "Plant Growth", "Protection from Energy", "Speak with Plants", "Water Breathing", "Water Walk",
                   "Wind Wall"]
phb_ranger_spells_4 = ["Conjure Woodland Beings", "Freedom of Movement", "Grasping Vine", "Locate Creature", "Stoneskin"]
phb_ranger_spells_5 = ["Commune with Nature", "Conjure Volley", "Swift Quiver", "Tree Stride"]


phb_sorcerer_cantrips = ["Acid Splash", "Blade Ward", "Chill Touch", "Dancing Lights", "Fire Bolt", "Friends",
                     "Light", "Mage Hand", "Mending", "Message", "Minor Illusion", "Poison Spray",
                     "Prestidigitation", "Ray of Frost", "Shocking Grasp", "True Strike"]
phb_sorcerer_spells_1 = ["Burning Hands", "Charm Person", "Chromatic Orb", "Color Spray", "Comprehend Languages",
...
phb_sorcerer_spells_2 = ["Alter Self", "Blindness/Deafness", "Blur", "Cloud of Daggers", "Crown of Madness",
...
phb_sorcerer_spells_3 = ["Blink", "Clairvoyance", "Counterspell", "Daylight", "Dispel Magic", "Fear", "Fireball",
...
phb_sorcerer_spells_4 = ["Banishment", "Blight", "Confusion", "Dimension Door", "Dominate Beast", "Greater Invisibility",
                     "Ice Storm", "Polymorph", "Stoneskin", "Wall of Fire"]
phb_sorcerer_spells_5 = ["Animate Objects", "Cloudkill", "Cone of Cold", "Creation", "Dominate Person", "Hold Monster",
                     "Insect Plague", "Seeming", "Telekinesis", "Teleportation Circle", "Wall of Stone"]
phb_sorcerer_spells_6 = ["Arcane Gate", "Chain Lightning", "Circle of Death", "Disintegrate", "Eyebite",
                     "Globe of Invulnerability", "Mass Suggestion", "Move Earth", "Sunbeam", "True Seeing"]
phb_sorcerer_spells_7 = ["Delayed Blast Fireball", "Etherealness", "Finger of Death", "Fire Storm", "Plane Shift",
                     "Prismatic Spray", "Reverse Gravity", "Teleport"]
phb_sorcerer_spells_8 = ["Dominate Monster", "Earthquake", "Incendiary Cloud", "Power Word Stun", "Sunburst"]
phb_sorcerer_spells_9 = ["Gate", "Meteor Swarm", "Power Word Kill", "Time Stop", "Wish"]


phb_warlock_cantrips = ["Blade Ward", "Chill Touch", "Eldritch Blast", "Friends", "Mage Hand", "Minor Illusion",
                    "Poison Spray", "Prestidigitation", "True Strike"]
phb_warlock_spells_1 = ["Armor of Agathys", "Arms of Hadar", "Charm Person", "Comprehend Languages",
                    "Expeditious Retreat", "Hellish Rebuke", "Hex", "Illusory Script",
                    "Protection from Evil and Good", "Unseen Servant", "Witch Bolt"]
phb_warlock_spells_2 = ["Cloud of Daggers", "Crown of Madness", "Darkness", "Enthrall", "Hold Person", "Invisibility",
                    "Mirror Image", "Misty Step", "Ray of Enfeeblement", "Shatter", "Spider Climb", "Suggestion"]
phb_warlock_spells_3 = ["Counterspell", "Dispel Magic", "Fear", "Fly", "Gaseous Form", "Hunger of Hadar",
                    "Hypnotic Pattern", "Magic Circle", "Major Image", "Remove Curse", "Tongues", "Vampiric Touch"]
phb_warlock_spells_4 = ["Banishment", "Blight", "Dimension Door", "Hallucinatory Terrain"]
phb_warlock_spells_5 = ["Contact Other Plane", "Dream", "Hold Monster", "Scrying"]
phb_warlock_spells_6 = ["Arcane Gate", "Circle of Death", "Conjure Fey", "Create Undead", "Eyebite", "Flesh to Stone",
                    "Mass Suggestion", "True Seeing"]
phb_warlock_spells_7 = ["Etherealness", "Finger of Death", "Forcecage", "Plane Shift"]
phb_warlock_spells_8 = ["Demiplane", "Dominate Monster", "Feeblemind", "Glibness", "Power Word Stun"]
phb_warlock_spells_9 = ["Astral Projection", "Foresight", "Imprisonment", "Power Word Kill", "True Polymorph"]


phb_wizard_cantrips = ["Acid Splash", "Blade Ward", "Chill Touch", "Dancing Lights", "Fire Bolt", "Friends", "Light",
                   "Mage Hand", "Mending", "Message", "Minor Illusion", "Poison Spray", "Prestidigitation",
                   "Ray of Frost", "Shocking Grasp", "True Strike"]
phb_wizard_spells_1 = ["Alarm", "Burning Hands", "Charm Person", "Chromatic Orb", "Color Spray", "Comprehend Languages",
                   "Detect Magic", "Disguise Self", "Expeditious Retreat", "False Life", "Feather Fall",
...
phb_wizard_spells_2 = ["Alter Self", "Arcane Lock", "Blindness/Deafness", "Blur", "Cloud of Daggers", "Continual Flame",
...
phb_wizard_spells_3 = ["Animate Dead", "Bestow Curse", "Blink", "Clairvoyance", "Counterspell", "Dispel Magic", "Fear",
...
phb_wizard_spells_4 = ["Arcane Eye", "Banishment", "Blight", "Confusion", "Conjure Minor Elementals", "Control Water",
...
phb_wizard_spells_5 = ["Animate Objects", "Bigby's Hand", "Cloudkill", "Cone of Cold", "Conjure Elemental",
...
phb_wizard_spells_6 = ["Arcane Gate", "Chain Lightning", "Circle of Death", "Contingency", "Create Undead",
...
phb_wizard_spells_7 = ["Delayed Blast Fireball", "Etherealness", "Finger of Death", "Forcecage", "Mirage Arcane",
...
phb_wizard_spells_8 = ["Antimagic Field", "Anitpathy/Sympathy", "Clone", "Control Weather", "Demiplane",
                   "Dominate Monster", "Feeblemind", "Incendiary Cloud", "Maze", "Mind Blank", "Power Word Stun",
                   "Sunburst", "Telepathy"]
phb_wizard_spells_9 = ["Astral Projection", "Foresight", "Gate", "Imprisonment", "Meteor Swarm", "Power Word Kill",
...
strix_artificer_spells_2 = ["Kinetic Jaunt", "Vortex Warp"]


strix_bard_spells_1 = ["Silvery Barbs"]
strix_bard_spells_2 = ["Borrowed Knowledge", "Kinetic Jaunt"]


strix_cleric_spells_2 = ["Borrowed Knowledge"]


strix_druid_spells_2 = ["Wither and Bloom"]


strix_sorcerer_spells_1 = ["Silvery Barbs"]
strix_sorcerer_spells_2 = ["Kinetic Jaunt", "Vortex Warp", "Wither and Bloom"]


strix_warlock_spells_2 = ["Borrowed Knoeledge"]


strix_wizard_spells_1 = ["Silvery Barbs"]
strix_wizard_spells_2 = ["Borrowed Knowledge", "Kinetic Jaunt", "Vortex Warp", "Wither and Bloom"]


# Explorer's Guide to Wildemount

wilde_wizard_cantrips = ["Sapping Sting"]
wilde_wizard_spells_1 = ["Gift of Alacrity", "Magnify Gravity"]
wilde_wizard_spells_2 = ["Fortune's Favor", "Immovable Object", "Wristpocket"]
wilde_wizard_spells_3 = ["Pulse Wave"]
wilde_wizard_spells_4 = ["Gravity Sinkhole"]
wilde_wizard_spells_5 = ["Temporal Shunt"]
wilde_wizard_spells_6 = ["Gravity Fissure"]
wilde_wizard_spells_7 = ["Tether Essence"]
wilde_wizard_spells_8 = ["Dark Star", "Reality Break"]
wilde_wizard_spells_9 = ["Ravenous Void", "Time Ravage"]
