...
class Baalzebul_Tiefling(Tiefling):
    ...
    def check_lvl(self):
        if PC.lvl >= 3 and "Ray of Sickness*" not in self.spells:
            self.spells.append("Ray of Sickness*")
        if PC.lvl >= 5 and "Crown of Madness*" not in self.spells:
            self.spells.append("Crown of Madness*")
...
class Dispater_Tiefling(Tiefling):
    ...
    def check_lvl(self):
        if PC.lvl >= 3 and "Disguise Self*" not in self.spells:
            self.spells.append("Disguise Self*")
        if PC.lvl >= 5 and "Detect Thoughts*" not in self.spells:
            self.spells.append("Detect Thoughts*")
...
class Fierna_Tiefling(Tiefling):
    ...
    def check_lvl(self):
        ...
        if PC.lvl >= 5 and "Suggestion*" not in self.spells:
...
class Levistus_Tiefling(Tiefling):
    def __init__(self):
        ...
        self.asi = [(2,1),(5,2)]
        self.spells = ["Ray of Frost*"]

    def check_lvl(self):
        if PC.lvl >= 3 and "Armor of Agathys*" not in self.spells:
            self.spells.append("Armor of Agathys*")
...
class Mammon_Tiefling(Tiefling):
    def __init__(self):
        ...
        self.spells = ["Mage Hand*"]

    def check_lvl(self):
        if PC.lvl >= 3 and "Tenser's Floating Disk*" not in self.spells:
            self.spells.append("Tenser's Floating Disk*")
        if PC.lvl >= 5 and "Arcane Lock*" not in self.spells:
...
class Mephistopheles_Tiefling(Tiefling):
    ...
    def check_lvl(self):
        ...
        if PC.lvl >= 5 and "Flame Blade*" not in self.spells:
            self.spells.append("Flame Blade*")
...
class Zariel_Tiefling(Tiefling):
    ...
    def check_lvl(self):
        if PC.lvl >= 3 and "Searing Smite*" not in self.spells:
            self.spells.append("Searing Smite*")
        if PC.lvl >= 5 and "Branding Smite*" not in self.spells:
            self.spells.append("Branding Smite*")
...
class Githyanki(Gith):
    ...
    def choices(self):
        chosen = False
        while not chosen:
            print("Choose a language other than Common or Gith.")
        ...
        while True:
            print("Choose a tool or skill proficiency.")
    ...
    def check_lvl(self):
        if PC.lvl >= 3 and "Jump*" not in self.spells:
            self.spells.append("Jump*")
        if PC.lvl >= 5 and "Misty Step*" not in self.spells:
...
class Githzerai(Gith):
    ...
    def check_lvl(self):
        if PC.lvl >= 3 and "Shield*" not in self.spells:
